...
def train(
    ...
    train_pipeline += gp.Unsqueeze([raw, mask_weights, gt_mask]) #c,y,x
    ...
    train_pipeline += SwapAxes([raw,lsd_weights,mask_weights,gt_lsd,pred_lsd,gt_mask,pred_mask],(0,1)) #c,n,y,x
