...
def train(
    ...
    sources = (tuple(
            gp.ZarrSource(
                ...
                datasets={
                    raw: f'2d_raw/{i}',
                    gt_mask: f'2d_traces_mask/{i}',
                    unlabelled_mask: f'2d_traces_mask/{i}'},
                array_specs={
                    raw: gp.ArraySpec(interpolatable=True),
                    gt_mask: gp.ArraySpec(interpolatable=True),
    ...
    train_pipeline += gp.GrowBoundary(gt_mask,steps=1)
    ...
    train_pipeline += gp.Unsqueeze([raw, weights, gt_mask]) #c,y,x
    ...
    train_pipeline += SwapAxes([raw,weights,gt_mask,pred_mask],(0,1)) #c,n,y,x
